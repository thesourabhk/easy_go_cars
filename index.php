...
<section class = "home_section">
    <div class="section-header">
        <div class="section-title" style = "font-size:50px; color:white">
            Find Best & Cheap Cars
        </div>
        <hr class="separator">
		<div class="section-tagline">
            From as low as R.s 300 per day with limited time offer discounts
		</div>					
	</div>
</section>
        ...
        <div class="row">
            <div class="col-lg-4 col-md-6">
                <div class="single-feature">
                    ...
                    <p>
                        We have got expert Technicians in our team to assist you with any kind of help required.
                    </p>
                </div>
            </div>
            <div class="col-lg-4 col-md-6">
                <div class="single-feature">
                    ...
                    <p>
                       We at easyGo car Rentals provide you with professional Service but with friendly support.We are here to provide to the best and cheapest car deals. 
                    </p>
                </div>
            </div>
            <div class="col-lg-4 col-md-6">
            ...
            <div class="col-lg-4 col-md-6">
                <div class="single-feature">
                    ...
                    <p>
                        The details you provide for making a booking are strictly confidential.
                    </p>
                </div>
            </div>
            <div class="col-lg-4 col-md-6">
                <div class="single-feature">
                    ...
                    <p>
                       We offer you to choose from a wide variety of car classes new high-quality vehicles meeting your needs and budget best.
                    </p>
                </div>
            </div>
            <div class="col-lg-4 col-md-6">
                <div class="single-feature">
                    ...
                    <p>
                       Your reviews are really important to us.The users can give thier reviews about their experience in the rental service.
                    </p>
                </div>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-lg-6 sm-padding">
                <div class="contact-info">
                    ...
                    <h3>
                        Mananthavadi Rd, Vidyaranyapura
                        <br>
            ...
            <div class="col-lg-4 col-md-6">
                <div class="footer_widget">
                    <a class="navbar-brand" href="">
                        Easy<span style = "color:#04DBC0">Go</span>&nbsp;CarRental
                    </a>
                    <p>
                        Getting dressed up and traveling with good friends makes for a shared, unforgettable experience.
                    </p>
            ...
            <div class="col-lg-4 col-md-6">
                <div class="footer_widget">
                    ...
                    <ul class = "contact_info">
                        <li>
                            <i class="fas fa-map-marker-alt"></i>Mananthavadi Rd, Vidyaranyapura,Mysuru,  Karnataka 570008
                        </li>
                        <li>
                            <i class="far fa-envelope"></i>sourabhd267@gmail.com
                        </li>
                        <li>
                            <i class="fas fa-mobile-alt"></i>+91 7367032377
                        </li>
                    </ul>
                </div>
            </div>
