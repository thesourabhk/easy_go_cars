				...
				<?php
					...
					if($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['signin-button']))
					{
						...
						if($count > 0)
						{
							...
							$_SESSION['username_easygo_car_rental'] = $username;
							$_SESSION['password_easygo_car_rental'] = $password;
							$_SESSION['user_id_easygo_car_rental'] = $row['user_id'];
							header('Location: dashboard.php');
							die();
						}
						else
		...
		<footer class="sticky-footer bg-white">
			<div class="container my-auto">
		  		<div class="copyright text-center my-auto">
					<span>Copyright &copy; Car Rental Website by SOURABH &amp; TANMOY 2021</span>
		  		</div>
			</div>
	  	</footer>
		<!-- End of Footer -->
